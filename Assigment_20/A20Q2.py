...
def FindDuplicate(path):
    ...
    fd = open("DuplicateLog.txt",'a')
    fd.write("\n\nDuplicate files in the directory:"+path+"\n")
    ...
    for Value in Result:
        for SubValue in Value:
            ...
            if(Count > 1):
                iCnt += 1
                fd.write("Duplicate File Name:"+SubValue+"\n")
        Count = 0

    fd.write("Number Of Duplicate Files are: " + str(iCnt) + "\n")            
    fd.close()
    print("Number Of Duplicate Files are: ",iCnt)      
